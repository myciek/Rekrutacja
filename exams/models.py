...
class Exercise(models.Model):
    ...
    written_exercise = models.BooleanField(default=False)
    max_points = models.DecimalField(max_digits=4, decimal_places=2)

    def __str__(self):
        return self.name

#Answers that you can choose
...
#Answers assigned to answer sheet
